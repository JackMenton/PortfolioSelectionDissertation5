...
class PolicyNetwork(nn.Module):
    ...
    this network returns a mean and stanard deviation - inputs are current wealth
    and time left in investment horizon'''
...
class ValueFuncNetwork(nn.Module):
    ...
    and time left in investment horizon, output the approximated value of the 
    input state'''
    def __init__(self, lr, input_dims, fc1_dims, fc2_dims, n_returns):
...
# -------------- TRAINING ----------- #
episode_scores = np.array([]) # stores score (value of initial state) of agent across episodes
